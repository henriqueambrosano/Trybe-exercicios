...
describe('Usando o método GET em /chocolates', function () {
  ...
  afterEach(function () {
    ...
    it('Retorna o total de chocolates', async function () {
      ...
      expect(response.body.response).equals(4);
    });
    it('Retorna chocolates baseado em uma pesquisa pelo nome', async function () {
    ...
    it('Retorna um array vazio caso nao encontre chocolates', async function () {
